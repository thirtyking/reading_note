以下是我针对已经阅读过的大模型相关论文给出的分类体系，包括了一级分类和二级分类。
请你给本论文打上合适的分类标签（可以有多个标签）。
如果有不在当前分类的标签，可以告诉我如何完善当前的分类体系，以便和本论文内容匹配
...
- **应用与智能体 (App & Agents)**
    - **自进化**：如何让Agent在工作中不断进化，学会规划任务、调用工具、反思错误，从而独立解决复杂问题？
    - **记忆**：如何帮助Agent 构建一个像人一样的记忆系统，提升记忆的准确性、召回率、一致性、泛化能力等？
